...
const translations: Record<Language, Translations> = {
  zh: {
    ...
    sections: {
      iceland: {
        title: "冰岛奇观",
        description: "这个展区展示了在2025年3月冰岛自驾游拍摄的精彩瞬间，包括蓝冰洞、极光和壮观的自然景观。",
      },
      popei: {
        title: "庞贝遗址",
  ...
  en: {
    ...
    sections: {
      iceland: {
        ...
        description: "This section showcases breathtaking moments captured during a self-driving tour in Iceland in March 2025, including blue ice caves, northern lights, and spectacular natural landscapes.",
      },
      popei: {
        title: "Pompeii Ruins",
