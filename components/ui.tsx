...
export default function UI({ toggleMusic, isMusicPlaying, debug = false, currentSection = "popei" }: UIProps) {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-black/80 text-white px-4 py-2 rounded text-center">
        {t.sections[currentSection as keyof typeof t.sections]?.title || currentSection}
      </div>
